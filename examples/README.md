# Global Stock Market API - Examples

This folder contains example code for using the Global Stock Market API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/globalstockmarket',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/globalstockmarket");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/globalstockmarket](https://docs.apiverve.com/ref/globalstockmarket)
