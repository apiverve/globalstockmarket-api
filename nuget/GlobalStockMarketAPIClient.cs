...
namespace APIVerve.API.GlobalStockMarket
{
    ...
    /// <summary>
    /// Client for the GlobalStockMarket API
    /// </summary>
    public class GlobalStockMarketAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/globalstockmarket";
        ...
        private static readonly Dictionary<string, ValidationRule> _validationRules = new Dictionary<string, ValidationRule>
        {
            ...
            { "year", new ValidationRule { Type = "integer", Required = false, Min = 2000, Max = 2030 } }
        };
        ...
        public GlobalStockMarketAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public GlobalStockMarketAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public GlobalStockMarketAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, GlobalStockMarketQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(GlobalStockMarketQueryOptions options)
        {
        ...
        public ResponseObj Execute(GlobalStockMarketQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(GlobalStockMarketQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(GlobalStockMarketQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(GlobalStockMarketQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(GlobalStockMarketQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(GlobalStockMarketQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(GlobalStockMarketQueryOptions options)
        {
