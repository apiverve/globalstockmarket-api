# Global Stock Market Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:globalstockmarket-api:1.1.13'
}
```
...
```java
import com.apiverve.globalstockmarket.GlobalStockMarketAPIClient;
import com.apiverve.globalstockmarket.APIResponse;
import com.apiverve.globalstockmarket.APIException;

// Initialize the client
GlobalStockMarketAPIClient client = new GlobalStockMarketAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/globalstockmarket](https://docs.apiverve.com/ref/globalstockmarket)
...
- **Documentation:** [https://docs.apiverve.com/ref/globalstockmarket](https://docs.apiverve.com/ref/globalstockmarket)
- **Issues:** [GitHub Issues](https://github.com/apiverve/globalstockmarket-api/issues)
