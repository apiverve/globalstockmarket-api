...
namespace APIVerve\Globalstockmarket;
...
/**
 * Client for the Global Stock Market API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/globalstockmarket?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/globalstockmarket';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\GlobalstockmarketClient] {$message}\n";
        }
    }
}
